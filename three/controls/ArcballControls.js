...
class ArcballControls extends EventDispatcher {
  constructor(camera, domElement = null, scene = null) {
    ...
    __publicField(this, "trackballRadius");
    ...
    __publicField(this, "calculateRotationAxis", (vec1, vec2) => {
      ...
      const x = this._rotationAxis.x
      const y = this._rotationAxis.y
      const z = this._rotationAxis.z
      // this._rotationAxis.setComponent(0, Math.sign(x) * (Math.abs(x) - Math.abs(cameraDirection.x)))
      // this._rotationAxis.setComponent(2,Math.sign(z) * (Math.abs(z) - Math.abs(cameraDirection.z)))
      // this._rotationAxis.projectOnPlane(cameraDirection).setComponent(1,y)
      // this._rotationAxis.setComponent(0,0)
      // this._rotationAxis.setComponent(2,0)
      // this._rotationAxis.cross(cameraDirection)
      // this._rotationAxis.setComponent(1,y)
      this._rotationAxis.normalize()
      // console.log(this._rotationMatrix, this._quat, this._rotationAxis);
      console.log(cameraDirection, this._rotationAxis);
      return this._rotationAxis.clone();
    });
    /**
    ...
    __publicField(this, "calculateTbRadius", (camera) => {
      ...
      if (camera instanceof PerspectiveCamera) {
        if (this.trackballRadius > 0) { return this.trackballRadius; }
    ...
    this.trackballRadius = undefined;
